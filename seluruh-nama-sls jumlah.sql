...
STRING_AGG(SUBSTRING(t1.pair_label, CHARINDEX('R', t1.pair_label), 5), ',') WITHIN GROUP (ORDER BY CAST(t1.pair_value AS INTEGER) ASC) AS SLS_2024, t2.r106c AS Jumlah_SLS_2024
