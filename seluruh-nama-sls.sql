SELECT t1.level_1_name AS Provinsi, t1.level_2_name AS Kab_Kota, t1.level_3_name AS Kecamatan, t1.level_4_name AS Desa, SUBSTRING(t1.pair_label, CHARINDEX('R', t1.pair_label), CHARINDEX('#', t1.pair_label) - CHARINDEX('R', t1.pair_label)) AS SLS
